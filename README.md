...
See [patterns.md](https://github.com/nholuongut/terraform-aws-alb/blob/master/docs/patterns.md) for additional configuration snippets for common usage patterns.
